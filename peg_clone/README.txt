...
THIS IS A CLONE OF JUST PEG. https://www.piumarta.com/software/peg/

leg is not included because leg is just peg trying to look like bison, and
therefore totally unnecesary and redundant.

THE BEST ALTERNATIVE TO FLEX AND BISON TOGETHER IN ONE.
Yes both lexis and grammar in one.
Also more intuitive and powerful.

UNDERSTAND the WHOLE thing just reading:
...
THE BEST EXAMPLE OF HOW TO USE PEG IS PEG ITSELF BECAUSE IT BOOTSTRAPS ITSELF.
Observe it by doing:
	make
	./peg_clone src_peg/peg.peg -o tmp_out.c
	diff tmp_out.c src_peg/peg.peg-c
	rm tmp_out.c
