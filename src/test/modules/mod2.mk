...
TARGET := test/modules/libmod_2.a
...
define POST_OPERS
	../src/test/modules/mod_make_redef_list.sh $(TARGET_DIR)/$(TARGET) m2
	../src/test/modules/mod_repl_common_syms.sh $(TARGET_DIR)/$(TARGET) m2 module2_code module2_data
