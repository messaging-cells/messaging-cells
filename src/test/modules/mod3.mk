...
TARGET := test/modules/libmod_3.a
...
define POST_OPERS
	../src/test/modules/mod_make_redef_list.sh $(TARGET_DIR)/$(TARGET) m3
	../src/test/modules/mod_repl_common_syms.sh $(TARGET_DIR)/$(TARGET) m3 module3_code module3_data
