...
SRC_CFLAGS := -DBJ_IS_ZNQ_CODE -Wall -std=gnu11 ${BJ_DBG_FLAG} -g -rdynamic -fno-omit-frame-pointer
SRC_CXXFLAGS := -DBJ_IS_ZNQ_CODE -Wall -std=c++14 ${BJ_DBG_FLAG} -g -rdynamic
