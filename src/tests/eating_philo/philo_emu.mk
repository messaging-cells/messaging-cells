...
SRC_CFLAGS := -DBJ_IS_EMU_CODE ${BJ_STD_EPH_CFLAGS} ${BJ_DBG_FLAG} ${SRC_IN_SECTIONS} -g -pthread
SRC_CXXFLAGS := -DBJ_IS_EMU_CODE ${BJ_STD_EPH_CXXFLAGS} ${BJ_DBG_FLAG} ${SRC_IN_SECTIONS} -g -pthread
